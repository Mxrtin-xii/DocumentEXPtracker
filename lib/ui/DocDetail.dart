...
void _saveDoc () {
    ...
    //Set the form ctrl value to save as a boolean in the doc instance to be sent to dbh
...
//if Docs id exist previously, it updates
//if the id does exists previously, (!>1), it sets it to 1 greater than the highest inserts
    if (widget.doc.id > -1) {
...
Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        //maps out menuoptions previously set to menudelete, to click with the onselected method which requires it 
                PopupMenuButton(
        ...
        body: Form(
            ...
            child: SafeArea(
                ...
                child: ListView(
                    ...
                    Row(children: <Widget>[
                        Expanded(child: Text('a: Alert @ 1.5 & 1 year(s)')),123
                            Switch(
